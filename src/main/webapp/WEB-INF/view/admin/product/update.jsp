...
<html lang="en">
  <head>
    ...
    <title>${updateProduct.name} - Trung HT</title>
                ...
                <div class="col-md-6 col-12 mx-auto">
                  ...
                  >
                    ...
                    <div class="mb-3 col-12 ">
                      ...
                      <input path="image" class="form-control" type="file" id="imageProduct" name="imageFile" accept=".jpg, .png, .jpeg">
                      <!-- Hidden input to store the current image path -->
                      <form:hidden path="image" id="currentImage" value="${updateProduct.image}"/>
                    </div>
                    <div class="mb-3 col-12 ">
                      <img src="/images/product/${updateProduct.image}" alt="Image preview" style="max-height: 250px; display: block;" id="imagePreview" >
                    </div>
    ...
    <script>
      $(document).ready(() => {
        $("#imageProduct").change((e) => {
          ...
          // Update the hidden input field with the new file name
          $("#currentImage").val(imageFile.name);
        });
      });
    </script>
  </body>
