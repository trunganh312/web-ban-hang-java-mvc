        ...
        <main>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a
                              ...
                              >Update</a
                            >
                            <a class="btn btn-danger" href="/admin/product/delete/${product.id}"
                              >Delete</a
                            >
                          </td>
                        </tr>
          ...
          <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
              <li class="page-item">
                <a
                  class="${(loop.index + 1 ) eq currentPage ? 'page-link disabled' : 'page-link'}"
              ...
              <li class="page-item">
                <a
                  class="${totalPages eq currentPage ? 'page-link disabled' : 'page-link'}"
                  href="/admin/product?page=${currentPage + 1}"
                  >Next</a
                >
              </li>
